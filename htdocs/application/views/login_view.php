...
<body style="background-color:<?php echo $color[0]->bgcolor; ?>">
		<div class = "container">
			...
			<div class = "col-sm-2"></div>
				<div class=" col-sm-8">
						<img src="<?php echo base_url();  ?>image/transtag_smaller2.png" alt="" style="width: 60%; margin-top: 20px; margin-left: 145px;"/>	
				<div class="banner" style="color: <?php echo $fontColor; ?>" >

					Today, most of the Lasallians feel
					<h1><?php echo $mood[0]->name; ?></h1>
				</div>
				<div class = "jumbotron" style = "background-color: <?php echo $jumboColor; ?>">
					<div id="login-search" class="form-group">
						<input type="text" class="form-control search-input" placeholder="Search for Professors, Organization, Organization Events, and Offices"/>
						<input type="submit" class="btn btn-info search-btn" value="Search"/>	
					</div>
					
					<div id="login-form-box" class="form-group">
						<img id="login-title" src="<?php echo base_url();  ?>image/trans_smaller.png" alt="" style="width: 100%;"/>		
					...
					<div id="register-form-box" class="form-group">
						...
						<form id="register-form" method="post" action="<?php echo base_url(); ?>index.php/account/register">
							...
							<!--	<input type="password" class="form-control adj-input" id="confirmPassword" placeholder="Confirm Password" name="password" style=""/> -->
=======
